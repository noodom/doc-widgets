...
|Dans le plugin
|image:commun_menu_plugins.png[role="related thumb",width=5] > image:commun_menu_programmation.png[role="related thumb",width=120] > image:commun_menu_widget.png[role="related thumb",width=80]
